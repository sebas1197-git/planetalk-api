module github.com/sebas1197-git/planetalk

go 1.25.0

// Dependencies will be added as you implement each module.
// After you write code that imports a package, run:  go mod tidy
// Planned libraries (from the plan):
...
//   github.com/twilio/twilio-go         -> OTP SMS
//   cloud.google.com/go/translate       -> message translation
